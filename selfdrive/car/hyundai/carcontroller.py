...
class CarController():
  ...
  def update(self, CC, CS, frame, sm, CP ):
    ...
    run_speed_ctrl = self.param_OpkrAccelProfile and CS.acc_active and self.SC != None and not CS.out.cruiseState.modeSel == 3
    ...
    # reset lead distnce after the car starts moving
      ...
      if is_sc_run:
        ...
        if CS.out.vEgo < 1 and CS.VSetDis < 50 and self.param_OpkrAccelProfile == 3:
