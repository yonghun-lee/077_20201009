...
class kyd_conf():
  ...
  def read_config(self):
    ...
    if os.path.isfile('/data/kyd.json'):
      ...
      if "Cluster_LKAS_Force_ON" not in self.config:
        self.config.update({"Cluster_LKAS_Force_ON":"0"})
        self.element_updated = True
      ...
      self.config = {"EnableLiveTune":"1", "steerMax":"255", "steerDeltaUp":"3", "steerDeltaDown":"7", \
                     ...
                     "steerRatio":"-1", "steerRateCost":"-1", "deadzone":"0.0", "lanechangeSpeed":"60", "Cluster_LKAS_Force_ON":"0", \
